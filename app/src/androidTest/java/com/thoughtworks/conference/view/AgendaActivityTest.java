...
public class AgendaActivityTest {
    ...
    public ActivityUnitTestRule<AgendaActivity> activityTestRule = new
            ActivityUnitTestRule<AgendaActivity>(getActivityProvider(), AgendaActivity.class,
                    false, false) {
            };
    ...
    public void swipeAndAssertOnAspire() {
        ...
        onData(instanceOf(SessionViewModel.class)).inAdapterView(allOf(withId(R.id.list_view),
                isDisplayingAtLeast(70)))
                .atPosition(0).onChildView(withId(R.id.location)).check(matches(withText
                ("Ballroom")));
    }
    ...
    public void shouldShowCategoriesAsViewPagersTitle() {
        ...
        onView(atPositionInViewGroup(slidingTabStripViewMatcher, 0)).check(matches(withChild
                (withText("CREATE"))));
        onView(atPositionInViewGroup(slidingTabStripViewMatcher, 1)).check(matches(withChild
                (withText("ASPIRE"))));
        onView(atPositionInViewGroup(slidingTabStripViewMatcher, 2)).check(matches(withChild
                (withText("BELONG"))));
    }
    ...
    private void mockAPIClientForSuccess() {
        doAnswer(new Answer() {
            ...
            public Object answer(InvocationOnMock invocation) throws Throwable {
                ...
                Session session1 = new Session("Craft", "Try your hand at craft", parseDate
                        ("2016-05-23T19:15:00+05:30"), parseDate("2016-05-23T20:15:00+05:30"),
                        Category.ASPIRE, "Ballroom");
                Session session2 = new Session("IOTT", "Awesome project", parseDate
                        ("2016-05-23T19:15:00+05:30"), parseDate("2016-05-23T20:15:00+05:30"),
                        Category.BELONG, "Grand Hall");
                Session session3 = new Session("Keynote", "By Roy Singham", parseDate
                        ("2016-05-23T17:15:00+05:30"), parseDate("2016-05-23T18:15:00+05:30"),
                        Category.CREATE, "Pre Function Area");
